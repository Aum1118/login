...
class Login extends Component {
  ...
  render() {
    ...
    return (
      <div
        className="row d-flex justify-content-center no-gutters bg-secondary"
        id="login-page"
      >
                ...
                <div className="hb-social-icons-wrapper mobile-mx-1">
                  ...
                  >
                    <div className="login-register-bg-btn social-bg bg-primary d-flex justify-content-between align-items-center hb-fix-btn m-0 hb-login-fix-hieght">
                      ...
                      <div
                        className="hb-btn-text login-register mx-auto"
                        id="btnLogin"
                      >
                        Login
                        <i
                  ...
                  <div
                    className="align-items-start pt-1 "
